...
##--------data extraction------
g_v.voltage, g_v.f_d = librosa.load('..\\Digital_filter\\wav\\Clean_file.wav', duration = g_v.T)
##--------adding noise--------
...
##-------save as WAV----------
sf.write('..\\Digital_filter\\wav\\Signal_with_noise.wav', g_v.voltage, g_v.f_d, subtype = 'PCM_24')
...
sf.write('..\\Digital_filter\\wav\\Matlab_simulation.wav', g_v.filt_volt, g_v.f_d, subtype = 'PCM_24')
